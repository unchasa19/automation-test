...
- Name: test\addaccout.spec.js >> Add account without type
- Location: test\addaccout.spec.js:64:5
...
=========================== logs ===========================
waiting for navigation to "https://qaplayground.com/bank/accounts" until "load"
============================================================
```
